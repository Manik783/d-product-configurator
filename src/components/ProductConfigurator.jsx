    ...
    return (
      <div className="flex flex-col items-center justify-center h-full w-full bg-gray-100">
        ...
        <button 
          ...
          className="mt-4 px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white transition-colors"
        >
          Reload Page
        </button>
      </div>
    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-4 p-4 rounded-lg bg-gray-100">
          <h3 className="text-lg font-bold mb-3 text-gray-900">Wood Finish</h3>
